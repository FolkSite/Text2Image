<?php
$_lang['text2image_prop_fontSize'] = 'Размер шрифта в пунктах (pt).';
$_lang['text2image_prop_fontFile'] = 'Файл со шрифтом в формате TrueType (.ttf).';
...
$_lang['text2image_prop_tpl'] = 'Чанк оформления каждого изображения.';
$_lang['text2image_prop_toPlaceholder'] = 'Если указан этот параметр, то результат будет сохранен в плейсхолдер, вместо прямого вывода на странице.';