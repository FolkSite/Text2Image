...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('text2image_core_path', null, $modx->getOption('core_path') . 'components/text2image/') . 'model/';
            $modx->addPackage('text2image', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/text2image/model/schema/text2image.mysql.schema.xml';
